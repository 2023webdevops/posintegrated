...
const menuItems = [
  ...
  { title: "POS Systems", href: "#posSystems" },
...
const Navigation = () => (
    <motion.ul style={list} variants={navVariants}>
        ...
        >
            <a
            href={item.href}
            className="font-sans text-black hover:text-primary transition-colors uppercase font-[650] [font-variation-settings:'wdth'_75] text-2xl tracking-wide"
            >
            {item.title}
            </a>
        </motion.li>
